...
const DICT = {
  ...
  // строки скрытой панели Microsoft — остаются для её возврата после одобрения Mojang
  ...
  // ---- каталог скинов ----
  'Каталог скинов': ['Skin catalog', 'Каталог скінів'],
  'Подборка с Laby.net прямо тут. Полную галерею с тегами и поиском удобнее смотреть на самом сайте — оттуда же можно вставить ссылку на понравившийся скин.': [
    'A selection from Laby.net right here. The full gallery with tags and search is easier to browse on the site itself — and you can paste a link to any skin you like from there.',
    'Добірка з Laby.net просто тут. Повну галерею з тегами й пошуком зручніше дивитися на самому сайті — звідти ж можна вставити посилання на вподобаний скін.'],
  'Сортировка': ['Sort by', 'Сортування'],
  'Популярные': ['Most used', 'Популярні'],
  'Только что загруженные': ['Just uploaded', 'Щойно завантажені'],
  'Показать': ['Show', 'Показати'],
  'Открыть NameMC': ['Open NameMC', 'Відкрити NameMC'],
  'Ссылка на скин (NameMC или Laby.net)': [
    'Skin link (NameMC or Laby.net)', 'Посилання на скін (NameMC або Laby.net)'],
  'Импорт': ['Import', 'Імпорт'],
  'Вставьте ссылку': ['Paste a link', 'Вставте посилання'],
  'Загрузка…': ['Loading…', 'Завантаження…'],
  'Ничего не нашлось': ['Nothing found', 'Нічого не знайшлося'],
  'Не распознал ссылку — нужна ссылка на скин с namemc.com или laby.net': [
    'Could not read that link — it must point to a skin on namemc.com or laby.net',
    'Не розпізнав посилання — потрібне посилання на скін з namemc.com або laby.net'],
  '%s: скин %sx%s добавлен в библиотеку': [
    '%s: a %sx%s skin added to the library', '%s: скін %sx%s додано до бібліотеки'],

  // ---- помощник: действия и разрешения ----
  'Стоп': ['Stop', 'Стоп'],
  'Остановить (Esc)': ['Stop (Esc)', 'Зупинити (Esc)'],
  'Остановлено': ['Stopped', 'Зупинено'],
  'Разрешить': ['Allow', 'Дозволити'],
  'Не надо': ['No thanks', 'Не треба'],
  'Разрешено': ['Allowed', 'Дозволено'],
  'Отклонено': ['Declined', 'Відхилено'],
  'Копировать': ['Copy', 'Копіювати'],
  'Скопировано': ['Copied', 'Скопійовано'],
  'копировать': ['copy', 'копіювати'],
  'скопировано': ['copied', 'скопійовано'],
  'Думаю…': ['Thinking…', 'Думаю…'],
  'Смотрю…': ['Looking…', 'Дивлюся…'],
  'Устанавливаю…': ['Installing…', 'Встановлюю…'],
  'Создаю сборку…': ['Creating instance…', 'Створюю збірку…'],
  'Собираю сборку…': ['Building the pack…', 'Збираю збірку…'],
  'Ставлю модпак — это надолго…': [
    'Installing the modpack — this takes a while…', 'Ставлю модпак — це надовго…'],
  'Создать сборку': ['Create instance', 'Створити збірку'],
  'Установить мод': ['Install mod', 'Встановити мод'],
  'Собрать сборку': ['Build a pack', 'Зібрати збірку'],
  'Установить готовый модпак': ['Install a ready-made modpack', 'Встановити готовий модпак'],
  'Скачает версию игры и загрузчик — это займёт место на диске.': [
    'Downloads the game version and the loader — this takes disk space.',
    'Завантажить версію гри та завантажувач — це займе місце на диску.'],
  'Модпаки весят много — это надолго.': [
    'Modpacks are large — this takes a while.', 'Модпаки важать багато — це надовго.'],
  'Зависимости поставятся вместе с ним.': [
    'Dependencies will be installed along with it.', 'Залежності встановляться разом із ним.'],
  'Помощник слишком долго ходит по кругу — переформулируйте просьбу': [
    'The assistant is going in circles — try rephrasing your request',
    'Помічник надто довго ходить по колу — переформулюйте прохання'],
  'Не получилось ответить': ['Could not answer', 'Не вдалося відповісти'],
  'Ставлю %s (%s из %s)…': ['Installing %s (%s of %s)…', 'Ставлю %s (%s з %s)…'],
  'Создаю сборку «%s»…': ['Creating instance “%s”…', 'Створюю збірку «%s»…'],
  'Источник: %s. %s': ['Source: %s. %s', 'Джерело: %s. %s'],
  '%s → сборка «%s»': ['%s → instance “%s”', '%s → збірка «%s»'],
  '%s — новая сборка со всеми модами автора': [
    '%s — a new instance with every mod from its author',
    '%s — нова збірка з усіма модами автора'],
  'Создаст сборку и поставит модов: %s': [
    'Creates the instance and installs this many mods: %s',
    'Створить збірку та встановить модів: %s'],
  'Остановлено. Успело установиться: %s.': [
    'Stopped. Managed to install: %s.', 'Зупинено. Встигло встановитися: %s.'],

  // ---- файл сборки .plusmodpack ----
  'Поделиться сборкой': ['Share this instance', 'Поділитися збіркою'],
  'Сохранить в файл': ['Save to a file', 'Зберегти у файл'],
  'Получится небольшой файл .plusmodpack со списком модов — сами моды в него не кладутся, они скачаются при установке. Такой файл можно отправить другу: если у него стоит Plus Launcher, двойной клик предложит поставить эту сборку.': [
    'You get a small .plusmodpack file with the list of mods — the mods themselves are not packed in, they are downloaded on install. Send that file to a friend: if they have Plus Launcher, a double click offers to install this instance.',
    'Вийде невеликий файл .plusmodpack зі списком модів — самі моди в нього не кладуться, вони завантажаться під час встановлення. Такий файл можна надіслати другові: якщо в нього стоїть Plus Launcher, подвійний клік запропонує поставити цю збірку.'],
  'Установить сборку?': ['Install this instance?', 'Встановити збірку?'],
  'Файл сборки открыт в лаунчере. Моды скачаются из каталога — файл содержит только их список.': [
    'The instance file is open in the launcher. Mods will be downloaded from the catalog — the file only holds their list.',
    'Файл збірки відкрито в лаунчері. Моди завантажаться з каталогу — файл містить лише їхній список.'],
  'Название сборки': ['Instance name', 'Назва збірки'],
  'Что поставится': ['What will be installed', 'Що встановиться'],
  'Установить': ['Install', 'Встановити'],
  'Сохранено, модов в файле: %s': ['Saved, mods in the file: %s', 'Збережено, модів у файлі: %s'],
  'Сохранено, модов в файле: %s. Не попали (нет в каталоге): %s': [
    'Saved, mods in the file: %s. Left out (not in the catalog): %s',
    'Збережено, модів у файлі: %s. Не потрапили (немає в каталозі): %s'],
  'Сборка готова: %s (%s из %s модов)': [
    'Instance ready: %s (%s of %s mods)', 'Збірка готова: %s (%s з %s модів)'],
  'Не встали: %s': ['Failed to install: %s', 'Не встановилися: %s'],
  'Строк в файле пропущено: %s — они записаны не так, как ожидает лаунчер.': [
    'Lines skipped in the file: %s — they are not written the way the launcher expects.',
    'Рядків у файлі пропущено: %s — вони записані не так, як очікує лаунчер.'],
  ...
  'История переписок': ['Chat history', 'Історія листувань'],
  'Прошлые разговоры': ['Past chats', 'Минулі розмови'],
  'Прошлых разговоров пока нет': ['No past chats yet', 'Минулих розмов поки немає'],
  'Удалить всю историю': ['Delete all history', 'Видалити всю історію'],
  'Удалить всю историю переписок?': [
    'Delete the whole chat history?', 'Видалити всю історію листувань?'],
  'Не удалось открыть разговор': ['Could not open that chat', 'Не вдалося відкрити розмову'],
  'только что': ['just now', 'щойно'],
  'мин назад': ['min ago', 'хв тому'],
  'ч назад': ['h ago', 'год тому'],

  // ---- настройка действий помощника ----
  'Разрешить помощнику создавать сборки и ставить моды': [
    'Let the assistant create instances and install mods',
    'Дозволити помічнику створювати збірки та ставити моди'],
  'Помощник сможет сам найти мод и установить его. Каждое такое действие он всё равно показывает отдельно, и без вашего «Разрешить» ничего не скачается. Снимите галочку — и он сможет только советовать.': [
    'The assistant will be able to find a mod and install it itself. It still shows every such action separately, and nothing is downloaded without your “Allow”. Clear the checkbox and it can only give advice.',
    'Помічник зможе сам знайти мод і встановити його. Кожну таку дію він усе одно показує окремо, і без вашого «Дозволити» нічого не завантажиться. Зніміть галочку — і він зможе лише радити.'],
};
