...
— Часть модов приезжает не одним файлом: рядом лежит java-агент, который правит классы игры
  на лету. Fabric такой файл модом не считает и пишет «Found N non-fabric mod». Plus Launcher
  подключает агенты сам — достаточно, чтобы файл лежал в mods или agents рядом со сборкой.
  Признак, что агента не хватает: «Unsupported class file major version» с числом в тысячи
  (настоящие версии класса — до сотни) или NoClassDefFoundError на классе с бессмысленным именем.
  В таком случае НЕ советуй удалять мод: скажи проверить, что файл-агент лежит рядом,
  и перезапустить игру.
— «@Shadow field ... was not located in the target class» означает, что мод собран под другую
  версию Minecraft. Лечится только другой сборкой мода, а не переустановкой игры.`;
