...
— «Играть» — карточки сборок. Клик по карточке выбирает сборку, на карточке есть значки папки и корзины.
...
— «Моды» — строка поиска сразу по Modrinth и CurseForge. Сверху выбираются сборка, тип
  ...
  Зависимости и Fabric API лаунчер ставит сам.
— «Скины» — загрузка скина на лицензию Microsoft и локальный скин для оффлайн-аккаунта.
— «Аккаунт» — вход Microsoft по коду или локальный профиль без лицензии.
— «Настройки» — ползунок памяти, JVM-аргументы, выбор и кнопки скачивания Java, папка лаунчера,
  Discord, обновления и раздел «Соединение и зеркала» с кнопкой «Проверить соединение»
