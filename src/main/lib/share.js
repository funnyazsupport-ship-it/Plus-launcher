...
function start(port = DEFAULT_PORT, events = () => {}) {
  ...
  return new Promise((resolve, reject) => {
    ...
    /*
     * Только со своей машины. Наружу выходит труба до сервера друзей, и она
     * подключается сюда же, через 127.0.0.1. Слушать все сетевые платы значило
     * бы открыть мир всем в местной сети мимо выключателя «пускать друзей».
     */
